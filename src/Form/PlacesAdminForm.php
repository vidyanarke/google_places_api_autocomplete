...
class PlacesAdminForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['places_api_autocomplete_key'] = [
      '#type' => 'textfield',
    ...
    foreach ($form_state->getValues() as $key => $value) {
      ...
      elseif ($key == 'places_api_autocomplete_key') {
        ...
        \Drupal::service('config.factory')
          ...
          ->set('places_api_autocomplete_key', $value)
          ->save();
      }
    }
    \Drupal::service('config.factory')
      ->getEditable('places.settings')
      ->set('places_api_autocomplete_options', $options)
      ->save();
  }
}
